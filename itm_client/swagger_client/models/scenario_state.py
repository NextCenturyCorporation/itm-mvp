...
class ScenarioState(object):
    ...
    def __init__(self, id=None, name=None, elapsed_time=None, scenario_complete=None, patients=None, medical_supplies=None):  # noqa: E501
    ...
    def scenario_complete(self):
        """Gets the scenario_complete of this ScenarioState.  # noqa: E501

        set to true if the scenario is complete; subsequent calls to /scenario/probe will return an error code  # noqa: E501

        :return: The scenario_complete of this ScenarioState.  # noqa: E501
        :rtype: bool
        """
