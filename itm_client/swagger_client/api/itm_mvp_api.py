...
class ItmMvpApi(object):
    ...
    def get_patient_heart_rate_with_http_info(self, scenario_id, patient_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/patient/{patientId}/getHeartRate', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_patient_vitals_with_http_info(self, scenario_id, patient_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/patient/{patientId}/getVitals', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_scenario_state_with_http_info(self, scenario_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/scenario/{scenarioId}/getState', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def tag_patient(self, scenario_id, patient_id, tag, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tag_patient(scenario_id, patient_id, tag, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param str scenario_id: The ID of the scenario containing the specified patient (required)
        :param str patient_id: The ID of the patient to tag (required)
        :param str tag: The tag to apply to the patient, chosen from triage categories (required)
        :return: str
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.tag_patient_with_http_info(scenario_id, patient_id, tag, **kwargs)  # noqa: E501
        else:
            (data) = self.tag_patient_with_http_info(scenario_id, patient_id, tag, **kwargs)  # noqa: E501
            return data

    def tag_patient_with_http_info(self, scenario_id, patient_id, tag, **kwargs):  # noqa: E501
        """Tag a patient with a triage category  # noqa: E501

        Apply a triage tag to the specified patient with the specified tag  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tag_patient_with_http_info(scenario_id, patient_id, tag, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['scenario_id', 'patient_id', 'tag']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if ('scenario_id' not in params or
                params['scenario_id'] is None):
            raise ValueError("Missing the required parameter `scenario_id` when calling `tag_patient`")  # noqa: E501
        # verify the required parameter 'patient_id' is set
        if ('patient_id' not in params or
                params['patient_id'] is None):
            raise ValueError("Missing the required parameter `patient_id` when calling `tag_patient`")  # noqa: E501
