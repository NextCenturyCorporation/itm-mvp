...
class ItmTa2EvalApi(object):
    ...
    def get_alignment_target_with_http_info(self, scenario_id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ta2/{scenarioId}/getAlignmentTarget', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_heart_rate_with_http_info(self, casualty_id, **kwargs):  # noqa: E501
        ...
        if 'casualty_id' in params:
            path_params['casualtyId'] = params['casualty_id']  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ta2/casualty/{casualtyId}/checkHeartRate', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_vitals(self, casualty_id, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_vitals(casualty_id, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_vitals_with_http_info(casualty_id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_vitals_with_http_info(casualty_id, **kwargs)  # noqa: E501
            return data

    def get_vitals_with_http_info(self, casualty_id, **kwargs):  # noqa: E501
        """Assess and retrieve all casualty vital signs  # noqa: E501

        Retrieve all vital signs of the specified casualty.  Not implemented for MVP, but anticipated as an example of finer grained choice than \"Treat patient B\".  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_vitals_with_http_info(casualty_id, async_req=True)
        >>> result = thread.get()
        ...
        if ('casualty_id' not in params or
                params['casualty_id'] is None):
            raise ValueError("Missing the required parameter `casualty_id` when calling `get_vitals`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ta2/casualty/{casualtyId}/checkVitals', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def respond_to_probe(self, body, **kwargs):  # noqa: E501
        """Respond to a probe  # noqa: E501

        Respond to a probe with a decision chosen from among its options  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.respond_to_probe(body, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param ProbeResponse body: the selection by a DM of an option in response to a probe (required)
        :return: State
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.respond_to_probe_with_http_info(body, **kwargs)  # noqa: E501
        else:
            (data) = self.respond_to_probe_with_http_info(body, **kwargs)  # noqa: E501
            return data

    def respond_to_probe_with_http_info(self, body, **kwargs):  # noqa: E501
        """Respond to a probe  # noqa: E501

        Respond to a probe with a decision chosen from among its options  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.respond_to_probe_with_http_info(body, async_req=True)
        >>> result = thread.get()
        ...
        if ('body' not in params or
                params['body'] is None):
            raise ValueError("Missing the required parameter `body` when calling `respond_to_probe`")  # noqa: E501
    ...
    def tag_patient(self, casualty_id, tag, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tag_patient(casualty_id, tag, async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.tag_patient_with_http_info(casualty_id, tag, **kwargs)  # noqa: E501
        else:
            (data) = self.tag_patient_with_http_info(casualty_id, tag, **kwargs)  # noqa: E501
            return data

    def tag_patient_with_http_info(self, casualty_id, tag, **kwargs):  # noqa: E501
        """Tag a casualty with a triage category  # noqa: E501

        Apply a triage tag to the specified casualty with the specified tag  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.tag_patient_with_http_info(casualty_id, tag, async_req=True)
        >>> result = thread.get()
        ...
        if ('casualty_id' not in params or
                params['casualty_id'] is None):
            raise ValueError("Missing the required parameter `casualty_id` when calling `tag_patient`")  # noqa: E501
        # verify the required parameter 'tag' is set
        if ('tag' not in params or
                params['tag'] is None):
            raise ValueError("Missing the required parameter `tag` when calling `tag_patient`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/ta2/casualty/{casualtyId}/tag', 'POST',
            path_params,
            query_params,
            header_params,
            body=body_params,
